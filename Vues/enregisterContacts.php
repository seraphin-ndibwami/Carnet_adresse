...
<body>
  ...
  <main>
    <div class="baralaterale">
      ...
      <a href="http://localhost/TP2/Vues/Contacts.php">
        <div class="contact">
          <i class="contact">
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<?php
  // var_dump($_GET);
  // var_dump (!isset($_GET['message']) && $_GET['message'] == "succes");

  if(isset($_GET['message']) && $_GET['message'] == "succes"){
    ?>
      <header>
        <img src="../Statiques/R.png" alt="" width="100px" height="100px">
      </header>
      <div>
        <p>Nouveau contact enregistré avec succes </p>
        <div class="main">
          <a href="./Enregistrer.php" class="btn">Nouveau Contact</a>
          <a href="./Contacts.php" class="btn">Afficher les contacts</a>
        </div>
      </div>
    <?php
  }else{
    ...
    <form action="../Controlleurs/enregisterContacts.php" method="post">
